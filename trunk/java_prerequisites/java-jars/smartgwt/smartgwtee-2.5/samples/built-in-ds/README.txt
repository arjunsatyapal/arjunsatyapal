...
SmartGWT EE takes care of automotically supporting the various operations such
as fetch, update, insert and delete without requiring you to write any
additional serverside code.
