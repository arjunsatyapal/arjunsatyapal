...
*/
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'GAEDS_js/sc/';}
...
);isc.B._maxIndex=isc.C+170;isc.EventHandler.captureEvents();if("2011.12.03_04.54.47"!=""&&!"2011.12.03_04.54.47".startsWith("${")&&!window.isc_expirationOff&&new Date()>Date.parseStandardDate("2011.12.03_04.54.47"))
...
);isc.evalBoundary;isc.B.push(isc.A.$we=function isc_Canvas__handleRectHover(_1,_2){if(this.$nw)this.$wd(this.$nw.part,"hover",_1,_2)}
