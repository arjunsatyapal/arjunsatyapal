...
--------------------
The SmartGWT EE Showcase contains many easy-to-follow illustrations of
SmartGWT EE's capabilities, and highlights features unavailable in the free
SmartGWT package.
...
Showcase webapp is started/stopped. The contents of the database may be viewed
