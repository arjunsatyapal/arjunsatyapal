...
public class AutoDeriveHibernateSample extends ShowcasePanel {
    private static final String DESCRIPTION = "If you have pre-existing Hibernate beans, SmartClient can automatically derive fully functional " +
            "DataSources given just the Java classname of the Hibernate Bean.  The grid below is connected " +
            "to a Hibernate-managed bean via the simple declarations in supplyItem.ds.xml - no other " +
