...
public class DynamicDataChart extends ShowcasePanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            DynamicDataChart panel = new DynamicDataChart();
            id = panel.getID();
            return panel;
        }
    ...
    public Canvas getViewPanel() {
        ...
        if(SC.hasAnalytics()) {
            if(SC.hasDrawing()) {
                ...
                "<p>Click <a href=\"http://www.smartclient.com/smartgwtee/showcase/#dynamicDataCharting\" target=\"\">here</a> to see this example on smartclient.com</p></div>");
