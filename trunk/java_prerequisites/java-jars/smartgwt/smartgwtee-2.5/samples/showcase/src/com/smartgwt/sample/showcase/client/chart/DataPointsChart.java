...
public class DataPointsChart extends ShowcasePanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            DataPointsChart panel = new DataPointsChart();
            id = panel.getID();
            return panel;
        }
    ...
    public Canvas getViewPanel() {
        ...
        if(SC.hasAnalytics()) {
            if(SC.hasDrawing()) {
                ...
                "<p>Click <a href=\"http://www.smartclient.com/smartgwtee/showcase/#dataPointsChart\" target=\"\">here</a> to see this example on smartclient.com</p></div>");
