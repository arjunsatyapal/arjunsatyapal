...
public class HBRelationOneToMany extends ShowcasePanel {

    private static final String DESCRIPTION = "SmartClient handles Hibernate One-to-Many relations transparently, such as a Country which has " +
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            HBRelationOneToMany panel = new HBRelationOneToMany();
            id = panel.getID();
            return panel;
        }
    ...
    public Canvas getViewPanel() {
        ...
        countryList.setDataSource(DataSource.get("countryOneToManyHB"));
        ...
        countryForm.setDataSource(DataSource.get("countryOneToManyHB"));

        final ListGrid cityList = new ListGrid();
        cityList.setDataSource(DataSource.get("cityOneToManyHB"));
