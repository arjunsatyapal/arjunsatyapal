...
public class AdaptiveFilterSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION =
        "<p>SmartClient combines large dataset handling with <b>adaptive</b> use of "+
        ...
        "becomes small enough, SmartClient switches to client-side filtering automatically "+
        "&mdash; enter more letters, or criteria on other columns, to see this. The label "+
        "underneath the grid flashes briefly every time SmartClient needs to visit the " +
        "server.</p>"+
        "<p>Delete part of the item name to see SmartClient automatically switch back to "+
