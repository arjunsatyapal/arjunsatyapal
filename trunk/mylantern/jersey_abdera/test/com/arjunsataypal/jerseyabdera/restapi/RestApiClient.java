...
public class RestApiClient {
    ...
    // "http://100.cnx-repo.appspot.com";
//    private static final String SERVER_URL = "http://127.0.0.1:8888/MyAtomServlet";
    private static final String SERVER_URL = "http://arjuns-test.appspot.com/MyAtomServlet";
    ...
    private static Credentials defaultcreds = new UsernamePasswordCredentials("username",
            "password");

    public static void main(String[] args) throws HttpException, IOException,
            URISyntaxException {
        /*
         * // Getting a UploadURL. PostMethod postResource = new
         * PostMethod(REST_SERVER_URL + CnxResources.BASE_URL);
         * postResource.setParameter("key", "value");
         * 
         * int statusCode = client.executeMethod(postResource); String
         * responseBody = postResource.getResponseBodyAsString();
         * 
         * String string = new String(responseBody); log.info("StatusCode = " +
         * statusCode);
         * 
         ...
         * 
         * // Uploading Blob. PostMethod uploadResource = new
         * PostMethod(SERVER_URL + uploadUrl); Part[] parts = { new
         * StringPart("param_name", "value"), new FilePart(file.getName(), file)
         * };
         * 
         * uploadResource.setRequestEntity(new MultipartRequestEntity(parts,
         * uploadResource.getParams())); int uploadStatusCode =
         * client.executeMethod(uploadResource);
         * log.info("******uploadStatusCode = " + uploadStatusCode);
         * 
         * // Downloading Blob.' String resourceUrl = REST_SERVER_URL +
         * CnxResources.BASE_URL + "/" + resourceId; log.info("ResourceUrl = " +
         * resourceUrl); GetMethod getResource = new GetMethod(resourceUrl); int
         * downloadCode = client.executeMethod(getResource);
         * log.info("DownloadCode = " + downloadCode); log.info("Body = " +
         * getResource.getResponseBodyAsString());
         */
        ...
        //
        // Person tal = postEntry.addContributor("Tal Dayan", "tal@google.com",
        // "http://profiles.google.com/tal");
        //
        ...
        // abderaClient.addCredentials(null, null, null, defaultcreds);
        //
        //
        // // IRI iri = new IRI(REST_SERVER_URL + CnxModules.BASE_URL);
        // IRI iri = new IRI(SERVER_URL);
        // // Document<Entry> postResponseDoc =
        //
        // abderaClient.post(iri.toString(), postEntry)
        // .getDocument();
        ...
        // // Downloading Blob.'
        // String moduleUrl = REST_SERVER_URL + CnxModules.BASE_URL + "/" +
        // moduleId;
        ...
        //
        //
        // log.info("*****Reaching here with root = " +
        // postResponseDoc.getRoot().toString());
        //
        // int x = 1;
    ...
    private static void doGetEntry() throws URISyntaxException, HttpException, IOException {
        abderaClient.addCredentials(null, null, null, defaultcreds);
        client.getState().setCredentials(AuthScope.ANY, defaultcreds);    
        
        String moduleUrl = SERVER_URL;
        GetMethod getResource = new GetMethod(moduleUrl);
        int downloadCode = client.executeMethod(getResource);
        log.info("DownloadCode = " + downloadCode);
        log.info("Body = " + getResource.getResponseBodyAsString());
