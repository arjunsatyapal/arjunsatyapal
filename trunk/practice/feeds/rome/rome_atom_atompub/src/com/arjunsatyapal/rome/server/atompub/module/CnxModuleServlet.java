...
public class CnxModuleServlet {
    private Logger logger = Logger.getLogger(CnxModuleServlet.class.getName());
    ...
    public Response getServiceDocument(@Context HttpServletRequest req,
            @Context HttpServletResponse res) throws IllegalArgumentException,
            UnsupportedEncodingException, JDOMException, IOException, FeedException {
        // TODO(arjuns) : Add exception handling.
        CnxAtomPubServices services = new CnxAtomPubServices();
        CnxModuleAtomHandler handler = services.createCnxModuleAtomHandler(req, res);
