...
public class CnxAtomPubConstants {
    ...
    public static final String COLLECTION_RESOURCE_NAME = "AtomPub Collection for CNX Resources.";
    /**
    ...
    public static final String COLLECTION_MODULE_NAME = "AtomPub Collection for CNX Modules.";
    ...
    /**
     * Path for GET operation relative to
     * {@link #COLLECTION_CNX_COLLECTION_REL_PATH}.
     */
