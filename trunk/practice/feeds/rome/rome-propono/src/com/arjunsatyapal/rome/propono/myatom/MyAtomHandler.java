 ...
 * the License.
 */
package com.arjunsatyapal.rome.propono.myatom;
 ...
 */
public class MyAtomHandler implements AtomHandler {
    private HttpServletRequest req;
    private HttpServletResponse resp;
    
    public MyAtomHandler(HttpServletRequest req, HttpServletResponse resp) {
        this.req = req;
        this.resp = resp;
    }
