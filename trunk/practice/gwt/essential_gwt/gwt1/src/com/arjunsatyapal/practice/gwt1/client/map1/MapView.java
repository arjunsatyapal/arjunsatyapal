...
public class MapView
  ...
  private final native void yahooMapDisplay(
      ...
      final String text) /*-{
    var myself= this;
    var map= myself.@com.arjunsatyapal.practice.gwt1.client.map1.MapView::yahooMap;
    ...
    map.panToLatLon(_c);
    myself.@com.arjunsatyapal.practice.gwt1.client.map1.MapView::setCoordinates(DD)(_c.Lat, _c.Lon);
    }
  ...
  /*-{
    ...
    this.@com.arjunsatyapal.practice.gwt1.client.map1.MapView::yahooMap= map;
    //
