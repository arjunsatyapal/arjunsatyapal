...
public class ConnectrApp implements EntryPoint {
    ...
    public void onModuleLoad() {
        pushServiceStreamFactory =
            (SerializationStreamFactory) PushService.App.getInstance();
        singleton = this;
    ...
    private void getLoggedInUser() {
        new RPCCall<UserAccountDTO>() {
            ...
            protected void callService(
                AsyncCallback<UserAccountDTO> cb) {
                loginService.getLoggedInUserDTO(cb);
            }
            
            @Override
            public void onSuccess(
                UserAccountDTO loggedInUserDTO) {
    ...
    public void showLoginView() {
        ...
        LoginPresenter loginPresenter =
            new LoginPresenter(eventBus, new LoginView());
    ...
    private void goAfterLogin() {
        ...
        userBadgePresenter =
            new UserBadgePresenter(loginService, eventBus, new UserBadgeView());
